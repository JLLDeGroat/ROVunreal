...
#include "SoulQuarrey.h"

ASoulQuarrey::ASoulQuarrey(const FObjectInitializer& ObjectInitializer)
	: ABaseCityStructure(ObjectInitializer) {

}

void ASoulQuarrey::PrepareLevelOne() {
...
void ASoulQuarrey::PrepareLevelTen() {

}
void ASoulQuarrey::PrepareLevelTwenty() {

}
void ASoulQuarrey::PrepareLevelThirty() {

}
void ASoulQuarrey::PrepareLevelFourty() {

}
void ASoulQuarrey::PrepareLevelFifty() {
